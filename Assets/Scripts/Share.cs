...
public class Share : MonoBehaviour {
    ...
    private string subject = "Install this amazing Game";
    private string Link = "https://play.google.com/store/apps/details?id=com.hats.pirsonescape";
    ...
    {
#if UNITY_ANDROID
        Application.OpenURL("market://details?id=com.hats.pirsonescape");
#elif UNITY_IPHONE
    ...
    public void TouchShare(){
        StartCoroutine(RequestShare());
    }

    public IEnumerator RequestShare() {
        yield return new WaitForEndOfFrame();
